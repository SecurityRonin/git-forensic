...
`git-forensic` is an offline Rust library. It performs no network communication,
collects no telemetry, and transmits no data of any kind. All processing of Git
object stores and repository artifacts happens entirely on your own machine,
under your control.
